...
bot.on('message', message => {
	if(message.content === prefix + "a1b2c33"){
		var txt_embed = new Discord.RichEmbed()
		.setTitle(":hammer_pick: Liste des commandes :hammer_pick:")
		.setColor("#42d1f4")
		.setThumbnail(message.author.avatarURL)
		.addField("Commandes", "TEST")
		.setTimestamp()
		.setDescription(`Commande effectuée par ${message.author.username}`)
		message.channel.send(txt_embed);
	}
})
